...
// Assigned to ixml.ErrorString if the system ixml library is in use.
var errorStringFunc = defaultErrorStringFunc

// defaultErrorStringFunc provides a basic ixmlErrorString implementation.
// This allows the ixml.ErrorString function to be used even if the IXML library
// is not loaded.
